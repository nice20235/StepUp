...
class Category(Base):
    ...
    slippers: Mapped[list["StepUp"]] = relationship("StepUp", back_populates="category", cascade="all, delete-orphan")
...
class StepUp(Base):
    ...
    images: Mapped[list["StepUpImage"]] = relationship("StepUpImage", back_populates="stepup", cascade="all, delete-orphan")
    ...
    def __repr__(self):
        return f"<StepUp(id={self.id}, name='{self.name}', size='{self.size}', price={self.price})>"


class StepUpImage(Base):
    ...
    stepup: Mapped[StepUp] = relationship("StepUp", back_populates="images")
    ...
    def __repr__(self):
        return f"<StepUpImage(id={self.id}, slipper_id={self.slipper_id}, primary={self.is_primary})>"
